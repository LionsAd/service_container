...
class DefaultFactory implements FactoryInterface {
  ...
  public static function getPluginClass($plugin_id, $plugin_definition = NULL, $required_interface = NULL) {
    ...
    elseif ($plugin_definition instanceof PluginDefinitionInterface) {
      ...
      throw new PluginException(sprintf('%s can only handle plugin definitions that are arrays or that implement %s, but %s given.', __CLASS__, 'PluginDefinitionInterface', $plugin_definition_type));
    }
